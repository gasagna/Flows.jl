...
@testset "quadrature                             " begin
    ...
    # integration method
    for (method, order, value, _g, _A) in [(RK4(     x, q, :NL), 4, 6.2, gfull, nothing),
                                           (CB3R2R2( x, q, :NL), 2, 19 , g,     A),
                                           (CB3R2R3e(x, q, :NL), 3, 5.5, g,     A),
                                           (CB3R2R3c(x, q, :NL), 3, 5.8, g,     A)]
                                           # (CB4R3R4( x, q, :NL), 4, 0.16)]
